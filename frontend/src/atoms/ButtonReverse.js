...
const PRIMARY_COLOR_CLASSES = 'bg-dark green dim f2 f5-ns';
const SECONDARY_COLOR_CLASSES = 'bg-green dark dim f2 f5-ns';


const COLORS = {
    dark: PRIMARY_COLOR_CLASSES,
    green: SECONDARY_COLOR_CLASSES,
